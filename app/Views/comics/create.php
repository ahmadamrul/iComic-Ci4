        ...
        <div class="col">
            ...
            <form action="/comics/save" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="Publisher" placeholder="Publisher" value="<?= old('publisher'); ?>" name="publisher">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Pages" class="col-sm-2 col-form-label">Pages</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="Pages" placeholder="Pages" value="<?= old('pages'); ?>" name="pages">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="Volumes" class="col-sm-2 col-form-label">Volumes</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="Volumes" placeholder="Volumes" value="<?= old('volumes'); ?>" name="volumes">
                    </div>
                </div>
                <div class="form-group row">
